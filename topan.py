...
# File tanda tangan per user (taruh file .png-nya di folder utama app, sejajar logo.png).
# Kalau usernya belum punya file sendiri, fallback ke "ttd_clean.png" (punya Asin).
TTD_FILES = {
    "asin": "ttd_clean.png",
        ...
        if sheet:
            try:
                ...
                if len(all_vals) > 1:
                    ...
                    # Tab ini sudah eksklusif milik user yang login (Antrean_<Nama>),
                    # jadi gak perlu filter kolom Sales lagi seperti waktu masih 1 sheet gabungan.
