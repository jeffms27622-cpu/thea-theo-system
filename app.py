...
# =========================================================
# 3. PDF ENGINE (PRESIDENTIAL SUITE - FIXED MULTIPAGE)
# =========================================================
class PenawaranPDF(FPDF):
    def header(self):
        # 1. BACKGROUND HEADER (NAVY) - Koordinat tetap 0
        ...
        # 5. TYPOGRAPHY (Gunakan koordinat absolut agar tidak geser margin)
        self.set_y(12)
        self.set_x(70)
...
def generate_pdf(no_surat, nama_cust, pic, df_order, subtotal, ppn, grand_total):
    ...
    # --- KUNCI MARGIN DISINI (Sangat Penting!) ---
    pdf.set_top_margin(65) # Ini yang bikin halaman 2 dst tidak makan kop
    pdf.set_auto_page_break(auto=True, margin=30)
    pdf.add_page()
    
    # --- MULAI KONTEN ---
    # Karena marjin sudah 65, kita tidak perlu set_y(65) lagi secara manual
    # Tapi untuk jaga-jaga halaman pertama tetap rapi:
    pdf.set_y(65) 
    
    # Judul Quotation (Rata Kanan)
    ...
    # Info Customer (Balik ke Kiri)
    # Gunakan set_y absolut hanya di halaman pertama jika perlu
    pdf.set_y(65) 
    ...
    # ... (Sisa kode tabel dan lainnya tetap sama) ...
    # Jangan lupa saat menggambar header tabel, pastikan koordinatnya lancar
    ...
    for i, row in df_order.iterrows():
        ...
        # Golden Stripe antar baris
        pdf.set_draw_color(184, 134, 11)
        pdf.set_line_width(0.1)
        pdf.line(10, pdf.get_y(), 200, pdf.get_y())
        fill = not fill

    # ... (Sisa kode total dan signature tetap sama) ...
