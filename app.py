...
def connect_gsheet():
    try:
        ...
        # Jika sheet kosong, kita buatkan Header otomatis biar ga error pas baca 'row['Waktu']'
...
# =========================================================
# 3. PDF ENGINE (PRESIDENTIAL SUITE DESIGN)
# =========================================================
class PenawaranPDF(FPDF):
    ...
    def footer(self):
        ...
        # --- PERBAIKAN FOOTER TEXT SESUAI REQUEST ---
...
def generate_pdf(no_surat, nama_cust, pic, df_order, subtotal, ppn, grand_total):
    ...
    # --- MULAI KONTEN (JARAK AMAN DARI HEADER) ---
    pdf.set_y(65) 
                ...
                if len(all_vals) > 1:
                    ...
                    if not pending.empty:
                        for idx, row in pending.iterrows():
                            ...
                            # AMAN: Gunakan .get() agar tidak error jika kolom 'Waktu' hilang
