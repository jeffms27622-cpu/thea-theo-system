...
# =========================================================
# 3. PDF ENGINE (PRESIDENTIAL SUITE - GOLD EDITION)
# =========================================================
class PenawaranPDF(FPDF):
    def header(self):
        ...
        # 3. THE GOLDEN PILLARS (TIANG EMAS)
        ...
        # 5. TYPOGRAPHY
        self.set_y(12); self.set_x(70)
        
        self.set_font('Arial', 'B', 20); self.set_text_color(255, 255, 255)
        self.cell(0, 8, COMPANY_NAME, ln=1)
        
        self.set_x(70); self.set_font('Arial', 'B', 10); self.set_text_color(184, 134, 11)
        self.cell(0, 6, "  ".join(SLOGAN.upper()), ln=1)
        
        # Garis bawah slogan
        self.set_fill_color(255, 255, 255); self.rect(70, 28, 120, 0.2, 'F')

        # Info Kontak (WA DIMUNCULKAN DISINI)
        self.set_y(32); self.set_x(70)
        self.set_font('Arial', '', 8); self.set_text_color(220, 220, 220)
        self.cell(0, 4, ADDR, ln=1)
        
        self.set_x(70)
        # Menampilkan Telp Kantor & WA Marketing
...
def generate_pdf(no_surat, nama_cust, pic, df_order, subtotal, ppn, grand_total):
    ...
    # Isi Tabel dengan 'Golden Stripe'
    ...
    for i, row in df_order.iterrows():
        ...
        # --- THE GOLDEN STRIPE (Garis Emas Tipis antar baris) ---
        pdf.set_draw_color(184, 134, 11) # Warna Emas
        pdf.set_line_width(0.1) # Sangat tipis & elegan
        pdf.line(10, pdf.get_y(), 200, pdf.get_y())
        
        fill = not fill

    # Reset garis ke normal (hitam/abu) untuk bagian bawah
